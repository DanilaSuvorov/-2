...
namespace многоугольники
{
...

    {
        ...
        public override void paintshit(Graphics paper)
        {
            ...
            paper.FillRectangle(brush, y1-R/2, x1-R/2, R, R);
    ...
    class circle : Versch
    {
        ...
        {
            SolidBrush brush = new SolidBrush(Color.Red);
            paper.FillEllipse(brush, y1-R/2, x1-R/2, R,  R);
    ...
    class triangle : Versch
    {
        ...
        {
            SolidBrush brush = new SolidBrush(Color.Red);
            Point point1 = new Point(y1, x1 - R / 2);
            Point point2 = new Point(y1 - R / 2, x1 + R / 2);
            Point point3 = new Point(y1 + R / 2, x1 + R / 2);
